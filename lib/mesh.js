...
exports.mesh = function(args, cbMesh)
{
  ...
  mesh.receive = function(packet, pipe)
  {
    ...
    if(!lob.isPacket(packet) && !(packet = lob.decloak("telehash",packet))) return log.debug('invalid packet',typeof packet); 
