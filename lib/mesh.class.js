...
function handshake_validate(handshake, message, mesh){
...
Mesh.prototype.handshake = function Mesh_handshake(id, handshake, pipe, message)
{
  ...
  var valid = handshake_validate(handshake, message, this);
  console.log("!valid")
  if (!valid)
    return false;
