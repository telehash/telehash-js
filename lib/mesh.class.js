...
/** set a callback for changes in links to this mesh.
 * TODO: mesh as eventEmitter (i.e. mesh.on('link'))
...
/**
 *  Main routing to handle incoming packets from any transport. decloak and dispatch
 * packet according to type
...
Mesh.prototype.discovered = function(mesh, to)
{
